...
local function OracleHUD_SetupTextFont(fontString, fontObject)
	if fontString and fontObject then
		fontString:SetFontObject(fontObject);
	end
end

function OracleHUD_SharedTooltip_OnLoad(self)
	NineSliceUtil.DisableSharpening(self.NineSlice);
	local style = nil;
	local isEmbedded = false;
	OracleHUD_SharedTooltip_SetBackdropStyle(self, style, isEmbedded);
...
function OracleHUD_SharedTooltip_OnHide(self)
...
function OracleHUD_SharedTooltip_SetDefaultAnchor(tooltip, parent)
...
function OracleHUD_SharedTooltip_ClearInsertedFrames(self)
...
function OracleHUD_SharedTooltip_SetBackdropStyle(self, style, embedded)
...
function OracleHUD_GameTooltip_AddBlankLinesToTooltip(tooltip, numLines)
...
function OracleHUD_GameTooltip_AddBlankLineToTooltip(tooltip)
	OracleHUD_GameTooltip_AddBlankLinesToTooltip(tooltip, 1);
end

function OracleHUD_GameTooltip_SetTitle(tooltip, text, overrideColor, wrap)
	tooltip:ClearLines();
	OracleHUD_GameTooltip_AddColoredLine(tooltip, text, overrideColor or HIGHLIGHT_FONT_COLOR, wrap)
end

function OracleHUD_GameTooltip_ShowDisabledTooltip(tooltip, owner, text, tooltipAnchor)
	tooltip:SetOwner(owner, tooltipAnchor);

	local wrap = true;
	OracleHUD_GameTooltip_SetTitle(tooltip, text, RED_FONT_COLOR, wrap);

	tooltip:Show();
end

function OracleHUD_GameTooltip_AddNormalLine(tooltip, text, wrap, leftOffset)
	OracleHUD_GameTooltip_AddColoredLine(tooltip, text, NORMAL_FONT_COLOR, wrap, leftOffset);
end

function OracleHUD_GameTooltip_AddHighlightLine(tooltip, text, wrap, leftOffset)
	OracleHUD_GameTooltip_AddColoredLine(tooltip, text, HIGHLIGHT_FONT_COLOR, wrap, leftOffset);
end

function OracleHUD_GameTooltip_AddInstructionLine(tooltip, text, wrap, leftOffset)
	OracleHUD_GameTooltip_AddColoredLine(tooltip, text, GREEN_FONT_COLOR, wrap, leftOffset);
end

function OracleHUD_GameTooltip_AddErrorLine(tooltip, text, wrap, leftOffset)
	OracleHUD_GameTooltip_AddColoredLine(tooltip, text, RED_FONT_COLOR, wrap, leftOffset);
end

function OracleHUD_GameTooltip_AddDisabledLine(tooltip, text, wrap, leftOffset)
	OracleHUD_GameTooltip_AddColoredLine(tooltip, text, DISABLED_FONT_COLOR, wrap, leftOffset);
end

function OracleHUD_GameTooltip_AddColoredLine(tooltip, text, color, wrap, leftOffset)
...
function OracleHUD_GameTooltip_AddColoredDoubleLine(tooltip, leftText, rightText, leftColor, rightColor, wrap, leftOffset)
...
function OracleHUD_GameTooltip_ShowSimpleTooltip(tooltip, text, overrideColor, wrap, owner, point, offsetX, offsetY)
	tooltip:SetOwner(owner, point, offsetX, offsetY);
	OracleHUD_GameTooltip_SetTitle(tooltip, text, overrideColor, wrap);
	tooltip:Show();
end

function OracleHUD_GameTooltip_InsertFrame(tooltipFrame, frame, verticalPadding)
	...
	OracleHUD_GameTooltip_AddBlankLinesToTooltip(tooltipFrame, numLinesNeeded);
...
OracleHUD_TooltipBackdropTemplateMixin = {};

function OracleHUD_TooltipBackdropTemplateMixin:TooltipBackdropOnLoad()
	NineSliceUtil.DisableSharpening(self.NineSlice);
...
function OracleHUD_TooltipBackdropTemplateMixin:SetBackdropColor(r, g, b, a)
	self.NineSlice:SetCenterColor(r, g, b, a);
end

function OracleHUD_TooltipBackdropTemplateMixin:GetBackdropColor()
	return self.NineSlice:GetCenterColor();
end

function OracleHUD_TooltipBackdropTemplateMixin:SetBackdropBorderColor(r, g, b, a)
	self.NineSlice:SetBorderColor(r, g, b, a);
end

function OracleHUD_TooltipBackdropTemplateMixin:GetBackdropBorderColor()
	return self.NineSlice:GetBorderColor();
end

function OracleHUD_TooltipBackdropTemplateMixin:SetBorderBlendMode(blendMode)
	self.NineSlice:SetBorderBlendMode(blendMode);
end

OracleHUD_DisabledTooltipButtonMixin = {};

function OracleHUD_DisabledTooltipButtonMixin:OnEnter()
...
function OracleHUD_DisabledTooltipButtonMixin:OnLeave()
	local tooltip = GetAppropriateTooltip();
	tooltip:Hide();
end

function OracleHUD_DisabledTooltipButtonMixin:SetDisabledTooltip(disabledTooltip, disabledTooltipAnchor)
	self.disabledTooltip = disabledTooltip;
	self.disabledTooltipAnchor = disabledTooltipAnchor;
end

function OracleHUD_DisabledTooltipButtonMixin:GetDisabledTooltip()
	return self.disabledTooltip, self.disabledTooltipAnchor;
end

function OracleHUD_DisabledTooltipButtonMixin:SetDisabledState(disabled, disabledTooltip, disabledTooltipAnchor)

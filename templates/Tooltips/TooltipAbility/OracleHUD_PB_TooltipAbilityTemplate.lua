...
--]]
ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO = {};
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:GetAbilityID() error("UI: Unimplemented Function") end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:GetCooldown() return 0 end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:GetRemainingDuration() return 0 end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:IsInBattle() error("UI: Unimplemented Function") end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:GetHealth(target) return 100 end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:GetMaxHealth(target) return 100 end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:GetAttackStat(target) return 0 end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:GetSpeedStat(target) return 0 end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:GetState(stateID, target) return 0 end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:GetWeatherState(stateID) return 0 end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:GetPadState(stateID) return 0 end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:GetPetOwner(taget) return Enum.BattlePetOwner.Ally end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:HasAura(auraID, target) return false end
function ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO:GetPetType(target) if ( self:IsInBattle() ) then error("UI: Unimplemented Function"); else return nil end end

function OracleHUD_PB_TooltipAbilityTemplate_GetInfoTable()
	local info = {};
	setmetatable(info, { __index = ORACLEHUD_PB_TOOLTIPABILITYTEMPLATE_INFO; });
	return info;
end

function OracleHUD_PB_TooltipAbilityTemplate_OnLoad(self)
	self.strongAgainstTextures = { self.StrongAgainstType1 };
	self.weakAgainstTextures = { self.WeakAgainstType1 };
end

function OracleHUD_PB_TooltipAbilityTemplate_SetAbility(self, abilityInfo, additionalText)
	...
	--Update description
	local description = OracleHUD_PB_TooltipAbilityTemplate_ParseText(abilityInfo, unparsedDescription);
	...
	self:SetAlpha(0);
	self:SetScript("OnUpdate", OracleHUD_PB_TooltipAbilityTemplate_UpdateSize);
end

function OracleHUD_PB_TooltipAbilityTemplate_UpdateSize(self)
...
do
	...
	function OracleHUD_PB_TooltipAbilityTemplate_ParseText(abilityInfo, unparsed)
		parsedAbilityInfo = abilityInfo;
		local parsed = string.gsub(unparsed, "%b[]", OracleHUD_PB_TooltipAbilityTemplate_ParseExpression);
		return parsed;
	end
	...
	local function OracleHUD_PB_TooltipAbilityTemplate_ParseExpressionInsecure(expression)
	...
	function OracleHUD_PB_TooltipAbilityTemplate_ParseExpression(expression)
		local expressionResult = scrub(securecall(OracleHUD_PB_TooltipAbilityTemplate_ParseExpressionInsecure, expression));

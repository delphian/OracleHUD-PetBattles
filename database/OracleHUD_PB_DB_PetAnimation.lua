-------------------------------------------------------------------------------
--- List of all animation types
ORACLEHUD_PB_DB_PET_ANIMATION_ENUM = {
	STAND = 0,
	DEATH = 1,
	SPELL = 2,
	STOP = 3,
...
ORACLEHUD_PB_DB_PET_ANIMATION_TEXT = {
	[0] = "Stand",
	[1] = "Death",
	[2] = "Spell",
	[3] = "Stop",
...
-------------------------------------------------------------------------------
--- Get an animation id based on it's name and pet id.
-- @param name		Name of animation or animation id.
-- @param petId		(Optional, only required for specific types) Unique pet identifier.
function OracleHUD_PB_DB_AnimationGetId(type, petId)
	local animationId = type
	if (type == nil) then
		error("OracleHUD_PB_DB_AnimationGetId(): Invalid arguments")
	end
	if (tonumber(type) == nil) then
		if (ORACLEHUD_PB_DB_PET_ANIMATION_ENUM[type:lower()] == nil) then
			error("Invalid animation enumeration")
		end
		animationId = ORACLEHUD_PB_DB_PET_ANIMATION_ENUM[type:lower()]
	end
	return animationId
end
-------------------------------------------------------------------------------
local ID = ORACLEHUD_PB_DB_PET_SPECIES_ID
ORACLEHUD_PB_DB_PET_ANIMATION_POSITION = {
	-- ANY WAY TO AUTOMATICALLY GET THE RATIO??
	[ID["Adder"]] = { forward = ID["Snake"] },
	[ID["Albino Snake"]] = { forward = ID["Snake"] },
	[ID["Alpine Hare"]] = { forward = ID["Rabbit"] },
	[ID["Arctic Hare"]] = { forward = ID["Rabbit"] },
	[ID["Ash Spiderling"]] = { forward = ID["Spider"] },
	[ID["Ash Viper"]] = { forward = ID["Snake"] },
	[ID["Bat"]] = {
		default	= {	camTar = { x = 1.00, y = 0.65, z = 0.55 }, camPos = { x = 8.80, y = 0.65, z = 0.55 }, ratio = 1.5 }
	},
	[ID["Black Rat"]] = { forward = ID["Rat"] },
	[ID["Bloodfever Tarantula"]] = { forward = ID["Spider"] },
	[ID["Blue Dasher"]] = {		
		default	= {	camTar = { x = 1.00, y = 0.70, z = 0.45 }, camPos = { x = 7.70, y = 0.75, z = 0.75 }, ratio = 1.8 }
	},
	[ID["Bombay Cat"]] = { forward = ID["Cat"] },
	[ID["Cat"]] = {
		default	= {	camTar = { x = 1.00, y = 0.70, z = 0.70 }, camPos = { x = 2.20, y = 0.70, z = 0.70 }, ratio = 1.25 }
	},
	[ID["Chicken"]] = {		
		default	= {	camTar = { x = 1.00, y = 0.70, z = 0.70 }, camPos = { x = 1.40, y = 0.70, z = 0.70 }, ratio = 1.0 }
	},
	[ID["Cornish Rex Cat"]] = { forward = ID["Cat"] },
	[ID["Desert Spider"]] = { forward = ID["Spider"] },
	[ID["Dusk Spiderling"]] = { forward = ID["Spider"] },
	[ID["Elfin Rabbit"]] = { forward = ID["Rabbit"] },
	[ID["Forest Spiderling"]] = { forward = ID["Spider"] },
	[ID["Grasslands Cottontail"]] = { forward = ID["Rabbit"] },
	[ID["Green Wing Macaw"]] = { forward = ID["Bat"] },
	[ID["Hare"]] = { forward = ID["Rabbit"] },
	[ID["Highlands Mouse"]] = { forward = ID["Rat"] },
	[ID["Ironbeak Duck"]] = {		
		default	= {	camTar = { x = 1.00, y = 0.70, z = 0.75 }, camPos = { x = 3.50, y = 0.70, z = 0.75 }, ratio = 0.9 }
	},
	[ID["King Snake"]] = { forward = ID["Snake"] },
	[ID["Long-tailed Mole"]] = { forward = ID["Rat"] },
	[ID["Molten Hatchling"]] = { forward = ID["Spider"] },
	[ID["Mountain Cottontail"]] = { forward = ID["Rabbit"] },
	[ID["Mouse"]] = { forward = ID["Rat"] },
	[ID["Nursery Spider"]] = { forward = ID["Spider"] },
	[ID["Olivetail Hare"]] = { forward = ID["Rabbit"] },
	[ID["Orange Tabby Cat"]] = { forward = ID["Cat"] },
	[ID["Plucky Duckling"]] = {		
		default	= {	camTar = { x = 1.00, y = 0.75, z = 0.75 }, camPos = { x = 8.00, y = 0.75, z = 0.75 }, ratio = 0.6 }
	},
	[ID["Rabbit"]] = {
		default	= {	camTar = { x = 1.00, y = 0.70, z = 0.70 }, camPos = { x = 1.90, y = 0.70, z = 0.70 }, ratio = 0.9 }
	},
	[ID["Rat"]] = {
		default	= {	camTar = { x = 1.00, y = 0.70, z = 0.70 }, camPos = { x = 2.60, y = 0.70, z = 0.70 }, ratio = 1.8 }
	},
	[ID["Rat Snake"]] = { forward = ID["Snake"] },
	[ID["Rattlesnake"]] = { forward = ID["Snake"] },
	[ID["Redridge Rat"]] = { forward = ID["Rat"] },
	[ID["Redridge Tarantula"]] = { forward = ID["Spider"] },
	[ID["Silver Tabby Cat"]] = { forward = ID["Cat"] },
	[ID["Smolderweb Hatchling"]] = { forward = ID["Spider"] },
	[ID["Snake"]] = {
		default	= {	camTar = { x = 1.00, y = 0.50, z = 0.70 }, camPos = { x = 3.60, y = 0.50, z = 0.70 }, ratio = 1.8 }
	},
	[ID["Snowshoe Rabbit"]] = { forward = ID["Rabbit"] },
	[ID["Snowshoe Hare"]] = { forward = ID["Rabbit"] },
	[ID["Spider"]] = {
		default	= {	camTar = { x = 1.00, y = 0.70, z = 0.70 }, camPos = { x = 6.60, y = 0.75, z = 0.75 }, ratio = 1.7 }
	},
	[ID["Stormwind Rat"]] = { forward = ID["Rat"] },
	[ID["Tree Python"]] = { forward = ID["Snake"] },
	[ID["Twilight Spider"]] = { forward = ID["Spider"] },
	[ID["Water Snake"]] = { forward = ID["Snake"] },
	[ID["Widow Spiderling"]] = { forward = ID["Spider"] },
	[ID["Wild Duckling"]] = {
		default	= {	camTar = { x = 1.00, y = 0.68, z = 0.75 }, camPos = { x = 6.00, y = 0.68, z = 0.75 }, ratio = 0.8 }
	},
	["BLANK"] = {
		default	= {	camTar = { x = 1.00, y = 0.70, z = 0.75 }, camPos = { x = 4.00, y = 0.70, z = 0.75 }, ratio = 1.0 }
	},
} -- Leave above comma for ease of copying.
-------------------------------------------------------------------------------
--- Get the position, facing, and lighting for an animation model.
-- @param speciesId		Species identifier of pet.
function OracleHUD_PB_DB_AnimationGetPosition(speciesId)
	local position = ORACLEHUD_PB_DB_PET_ANIMATION_POSITION[speciesId]
	if (position ~= nil and position.forward ~= nil) then
		position = ORACLEHUD_PB_DB_PET_ANIMATION_POSITION[position.forward]
	end
	return OracleHUD_TableCopy(position)
end
